...
/// <summary>
/// Single entry representing a follow request you have received.
/// Maps to JSON fields: `title`, `media_list_data`, and `string_list_data`.
/// </summary>
public class FollowRequestReceivedProfile
{
    /// <summary>
    ...
    /// Kept as <see cref="JsonElement"/> until concrete structure is provided.
